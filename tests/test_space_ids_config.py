...
class TestSpaceIdsConfiguration:
    ...
    def test_config_loads_space_ids_from_yaml(self):
        ...
        assert 'efd91f05-87cf-4c4c-a04d-0a970f8d30a7' in goodmem_config.space_ids  # Ibn Katheer
        assert 'd04d8032-3a9b-4b83-b906-e48458715a7a' in goodmem_config.space_ids  # Qurtubi
    ...
    def test_mawsuah_config_loads_single_space(self):
        ...
        assert '2d1f3227-8331-46ee-9dc2-d9265bfc79f5' in goodmem_config.space_ids  # Mawsuah
